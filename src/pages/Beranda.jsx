      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <a href="/ai-detection" className="block">
              <div className="bg-[#6D7E5E] p-6 rounded-lg shadow-md">
                ...
                <p className="text-sm text-white text-left">
                  ...
                  kami akan memberikan diagnosis serta langkah-langkah
                  perawatan.
                </p>
              </div>
            </a>
            ...
            {/* Feature 3: Guide Download */}
            <a href="/guide-download" className="block">
              <div className="bg-[#6D7E5E] p-6 rounded-lg shadow-md">
                <img
                ...
                <p className="text-sm text-white text-left">
                  ...
                  mulai dari pemula hingga ahli. Dapatkan inspirasi dan cara
                  tepat menjaga tanaman Anda tetap sehat dan subur!
                </p>
              </div>
            </a>
          </div>
      ...
      <section className="py-12 bg-[#E7F0DC]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Article Card 1 */}
            <a href="/artikelsaatdibuka" className="block">
            ...
            <a href="/artikelsaatdibuka" className="block">
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-900 mt-2 text-left">
                    Artikel ini membahas berbagai jenis hama yang sering
                    menyerang tanaman bunga melati.
                  </p>
                </div>
              </div>
            </a>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mt-2 text-left">
                    Artikel ini membahas berbagai jenis hama yang sering
                    menyerang tanaman bunga Anggrek.
                  </p>
                </div>
              </div>
            </a>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <div className="md:ml-8">
            ...
            <button
              onClick={() => navigate("/Tentangkami")} // Navigate to the "Tentang Kami" page
