      ...
      <NavbarAdmin>
        ...
        <div className="p-6">
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-6 text-gray-800">Edit Isi Panduan</h2>
            ...
            {/* Konten Panduan */}
            <h3 className="text-xl font-semibold mt-6 mb-4 text-gray-800">Konten Panduan</h3>
            ...
            <div className="mb-4">
              ...
              <textarea id="description" className="w-full p-2 border border-green-500 rounded-md" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Deskripsi Panduan" />
            </div>

            {/* Input Tips & Trick */}
            <div className="mb-4">
              <label htmlFor="tips" className="block font-semibold mb-2 text-gray-700">
                Tips & Trick
              </label>
              <textarea id="tips" className="w-full p-2 border border-green-500 rounded-md" value={tips} onChange={(e) => setTips(e.target.value)} placeholder="Tips & Trick" />
            </div>

            {/* Unduh PDF */}
            <div className="mb-4">
              <button className="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">Unduh PDF</button>
            </div>
