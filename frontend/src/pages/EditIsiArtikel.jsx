      ...
      <NavbarAdmin>
        ...
        <div className="p-6">
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-6 text-gray-800">Edit Isi Artikel</h2>
            ...
            {/* Input Penerbit */}
            <div className="mb-4">
              <label htmlFor="publisher" className="block font-semibold mb-2 text-gray-700">
                Penerbit
              </label>
              <input id="publisher" type="text" className="w-full p-2 border border-green-500 rounded-md" value={publisher} onChange={(e) => setPublisher(e.target.value)} placeholder="Penerbit Artikel" />
            </div>

            {/* Input Tanggal Terbit */}
            <div className="mb-4">
              <label htmlFor="publishDate" className="block font-semibold mb-2 text-gray-700">
                Tanggal Terbit
              </label>
              <input id="publishDate" type="date" className="w-full p-2 border border-green-500 rounded-md" value={publishDate} onChange={(e) => setPublishDate(e.target.value)} />
            </div>
            ...
            <div className="mb-4">
              ...
              {image && (
                <div className="mt-4">
                  ...
                  <img src={URL.createObjectURL(image)} alt="Preview" className="w-full h-48 object-cover rounded-md mb-2" />
                  <button onClick={handleRemoveImage} className="bg-red-500 text-white px-4 py-2 rounded">
                    Hapus Gambar
                  </button>
                </div>
              )}
