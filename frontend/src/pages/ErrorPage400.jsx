      ...
      <div className="relative flex flex-col md:flex-row max-w-[1440px] w-full min-h-screen bg-neutral-50 items-center z-10">
        ...
        <div className="flex flex-col items-center w-full md:w-1/2 p-6 md:p-12 lg:p-24 space-y-6">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-red-600">400 - Permintaan Buruk</h1>
            <p className="mt-4 text-xl font-semibold text-[#000000cc]">Permintaan yang Anda kirimkan tidak dapat diproses karena kesalahan dari pihak klien.</p>
          </div>

          {/* Button to go back to home */}
          <button type="button" onClick={handleGoHome} className="w-full max-w-md h-14 bg-tanamanku-2 hover:bg-tanamanku-3 active:bg-tanamanku-4 rounded-lg font-bold text-black mt-6">
