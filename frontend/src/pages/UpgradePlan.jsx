  ...
  return (
    <div className="flex flex-col min-h-screen w-full m-0 p-0">
      ...
      <div className="flex flex-col items-center flex-grow p-4 md:p-14 bg-gray-50">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mt-4 mb-8 md:mb-12 text-center">
          Upgrade your plan
        </h2>
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center w-full max-w-3xl">
          ...
          <CardUpgradePlan
            title="Free"
            price="Rp.0 /bulan"
            description="Temukan bagaimana deteksi AI dapat membantu dalam aktivitas harianmu."
            buttonText="Rencana koneksi Anda"
            sub="Dengan Free, Anda bisa menikmati:"
            features={[
              "Akses terbatas ke deteksi AI hanya 5 kali",
              "Proses deteksi yang cepat dan akurat",
              "Dukungan free kapan saja",
            ]}
          ...
          <CardUpgradePlan
            ...
            features={[
              "Akses tanpa batas ke deteksi AI",
              "Proses deteksi yang lebih cepat dan akurat",
              "Dukungan premium kapan saja",
            ]}
