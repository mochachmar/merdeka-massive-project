    ...
    <div className="relative min-h-screen w-full flex items-center justify-center bg-neutral-50">
      ...
      <div
        ...
        style={{
          ...
          filter: 'brightness(0.85)', // Optional: darken background
        }}
      ></div>
      ...
      <div className="relative flex flex-col md:flex-row max-w-[1440px] w-full min-h-screen bg-neutral-50 items-center z-10">
        ...
        <div className="flex flex-col items-center w-full md:w-1/2 p-6 md:p-12 lg:p-24 space-y-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-black">Selamat datang di TanamanKu</h1>
            <p className="mt-4 text-xl font-semibold text-[#000000cc]">Buat akun baru dan mulailah menjelajahi semua fitur kami!</p>
          </div>

          {/* Button to navigate to EmailCreate */}
          <button type="button" onClick={handleEmailSignUp} className="w-full max-w-md h-14 bg-tanamanku-2 hover:bg-tanamanku-3 active:bg-tanamanku-4 rounded-lg font-bold text-black">
            Daftar dengan Email
          </button>
          ...
          <div className="text-center mt-6">
            <p className="text-base font-semibold text-[#5b5b5b]">
              ...
              <span className="text-black cursor-pointer hover:text-blue-500" onClick={handleSignIn}>
                Masuk
              </span>
            </p>
          </div>
