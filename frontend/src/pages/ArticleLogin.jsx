...
function Article(props) {
  ...
  useEffect(() => {
    ...
    async function fetchDetail() {
      ...
      var response = await axios.get("http://localhost:5000/api/articles");
    ...
    <>
      ...
      >
        ...
        <div className="p-4 bg-white">
          ...
          {article.created_by && (
            <p className="text-gray-600 text-sm mt-1">By {article.created_by}</p>
          )}
        </div>
      </Link>
    </>
