  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div onClick={() => navigate('/deteksi-penyakit')} className="cursor-pointer bg-[#6D7E5E] p-6 rounded-lg shadow-md transform transition-transform hover:scale-105 duration-300 hover:shadow-lg">
            ...
            <div onClick={() => navigate('/artikel-penyakit-tanaman-login')} className="cursor-pointer bg-[#6D7E5E] p-6 rounded-lg shadow-md transform transition-transform hover:scale-105 duration-300 hover:shadow-lg">
            ...
            <div onClick={() => navigate('/panduan-login')} className="cursor-pointer bg-[#6D7E5E] p-6 rounded-lg shadow-md transform transition-transform hover:scale-105 duration-300 hover:shadow-lg">
      ...
      <section className="py-12 bg-[#E7F0DC]">
        ...
        <div className="flex justify-center">
          <button onClick={() => navigate('/artikel-penyakit-tanaman-login')} className="mt-6 bg-[#6D7E5E] text-white px-6 py-2 rounded-md border-2 border-[#45543D]">
            Selengkapnya
          </button>
        </div>
      </section>
