      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div onClick={() => navigate('/sign-in')} className="cursor-pointer bg-[#6D7E5E] p-6 rounded-lg shadow-md transform transition-transform hover:scale-105 duration-300 hover:shadow-lg">
            ...
            <div onClick={() => navigate('/artikel-penyakit-tanaman')} className="cursor-pointer bg-[#6D7E5E] p-6 rounded-lg shadow-md transform transition-transform hover:scale-105 duration-300 hover:shadow-lg">
            ...
            <div onClick={() => navigate('/panduan')} className="cursor-pointer bg-[#6D7E5E] p-6 rounded-lg shadow-md transform transition-transform hover:scale-105 duration-300 hover:shadow-lg">
